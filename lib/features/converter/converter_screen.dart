  ...
  Future<void> _calculateImmediateConversion() async {
    ...
    if (_selectedCategory == ConversionCategory.currency) {
      ...
      try {
        ...
        setState(() {
          _resultValue = result >= 100 ? result.toStringAsFixed(2) : (result >= 1 ? result.toStringAsFixed(3) : result.toStringAsPrecision(4));
          _statusMessage = "Canlı piyasa kuruyla çevrildi (1 $_fromUnit = ${(result / amount).toStringAsFixed(2)} $_toUnit)";
          _isLoading = false;
        });
                            ...
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(item['to']!, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 13)),
                                ],
                              ),
                            );
                          },
